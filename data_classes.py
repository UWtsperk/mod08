...
class Person:
    ...
    Properties:
    :param first_name (str): The person's first name.
    :param last_name (str): The person's last name.

    ChangeLog:
    - TPerkins, 12.3.2023: Created the class.
    """
...
class Employee(Person):
    ...
    Properties:
    :param first_name (str): The employee's first name.
    :param last_name (str): The employee's last name.
    :param review_date (date): The data of the employee review.
    :param review_rating (int): The review rating of the employee's performance (1-5)
